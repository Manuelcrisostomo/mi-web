  ...
  root.innerHTML += `
    <div class="dashboard">
      ...
      <div class="actions">
        ...
        <button id="historyBtn">📜 Ver historial completo</button>
        <button id="saveBtn">💾 Guardar medición</button>
...
// ================================================
// FUNCION MOSTRAR DATOS DEL DISPOSITIVO
// ================================================
...
// ================================================
// GUARDAR HISTORIAL COMO PDF / EXCEL
// ================================================
